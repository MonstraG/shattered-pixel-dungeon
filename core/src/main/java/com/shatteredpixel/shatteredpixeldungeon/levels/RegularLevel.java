...
public abstract class RegularLevel extends Level {
	...
	protected void createItems() {
		...
		if (Document.ADVENTURERS_GUIDE.allPagesFound()) {
			...
			Document regionDoc = switch (region) {
				default -> null;
				case 1 -> Document.SEWERS_GUARD;
				case 2 -> Document.PRISON_WARDEN;
				case 3 -> Document.CAVES_EXPLORER;
				case 4 -> Document.CITY_WARLOCK;
				case 5 -> Document.HALLS_KING;
			};
