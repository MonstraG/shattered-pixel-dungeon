...
public class v0_7_X_Changes {
	...
	public static void add_v0_7_2_Changes(ArrayList<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.PREFS), Messages.get(ChangesScene.class, "misc"),
				"""
						_-_ The Identification system has been adjusted to require EXP gain in addition to item uses. This change prevents exploits where an item could be used in unintended ways to rapidly ID it. Items should ID at about the same rate if exp is gained while using them.
