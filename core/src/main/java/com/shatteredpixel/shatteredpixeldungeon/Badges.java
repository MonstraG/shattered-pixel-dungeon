...
public class Badges {
	...
	public static void validateBossChallengeCompleted() {
		Badge badge = switch (Dungeon.depth) {
			case 5 -> Badge.BOSS_CHALLENGE_1;
			case 10 -> Badge.BOSS_CHALLENGE_2;
			case 15 -> Badge.BOSS_CHALLENGE_3;
			case 20 -> Badge.BOSS_CHALLENGE_4;
			case 25 -> Badge.BOSS_CHALLENGE_5;
			default -> null;
		};
	...
	public static void validateMastery() {
		...
		Badge badge = switch (Dungeon.hero.heroClass) {
			...
			case DUELIST -> Badge.MASTERY_DUELIST;
		};
	...
	public static List<Badge> filterReplacedBadges(boolean global) {
		...
		badges.removeIf(badge -> (!global && badge.meta) || badge.image == -1);
