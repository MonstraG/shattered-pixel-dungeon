...
public class PitRoom extends SpecialRoom {
	...
	public void paint(Level level) {
		...
		Item mainLoot = null;
		do {
			mainLoot = switch (Random.Int(3)) {
				case 0 -> Generator.random(Generator.Category.RING);
				case 1 -> Generator.random(Generator.Category.ARTIFACT);
				case 2 -> Generator.random(Random.oneOf(
