...
public enum Icons {
	...
	public static Image get(HeroClass cl) {
		return switch (cl) {
			case WARRIOR -> get(Icons.WARRIOR);
			case MAGE -> get(Icons.MAGE);
			case ROGUE -> get(Icons.ROGUE);
			case HUNTRESS -> get(Icons.HUNTRESS);
			case DUELIST -> get(Icons.DUELIST);
			default -> null;
		};
	}
	...
	public static Image get(Level.Feeling feeling) {
		return switch (feeling) {
			default -> get(DEPTH);
			case CHASM -> get(DEPTH_CHASM);
			case WATER -> get(DEPTH_WATER);
			case GRASS -> get(DEPTH_GRASS);
			case DARK -> get(DEPTH_DARK);
			case LARGE -> get(DEPTH_LARGE);
			case TRAPS -> get(DEPTH_TRAPS);
			case SECRETS -> get(DEPTH_SECRETS);
		};
	}
}
