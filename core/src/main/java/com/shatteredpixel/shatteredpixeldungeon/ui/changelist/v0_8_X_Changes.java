	...
	public static void add_v0_8_2_Changes(ArrayList<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(new WandOfRegrowth(),
				"""
						...
						_-_ Lotus lifespan adjusted to 25+3*lvl, from 4*lvl\s
	...
	public static void add_v0_8_0_Changes(ArrayList<ChangeInfo> changeInfos) {
		...
		if (DeviceCompat.isDesktop()) {
			...
			changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_TIWAZ, null), "Update Notification",
					"""
							A little blinking button will now appear in the bottom-left of the title screen if an update is available for the game.\s
