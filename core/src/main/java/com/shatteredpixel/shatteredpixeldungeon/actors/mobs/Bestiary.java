		...
		return switch (depth) {
			...
			case 2 ->
				//2x rat, 1x snake, 2x gnoll
					new ArrayList<>(Arrays.asList(Rat.class, Rat.class,
							Snake.class,
							Gnoll.class, Gnoll.class));
			case 3 ->
				//1x rat, 1x snake, 3x gnoll, 1x swarm, 1x crab
					new ArrayList<>(Arrays.asList(Rat.class,
							Snake.class,
			...
			case 4, 5 ->
				//1x gnoll, 1x swarm, 2x crab, 2x slime
					new ArrayList<>(Arrays.asList(Gnoll.class,
							Swarm.class,
			...
			case 6 ->
				//3x skeleton, 1x thief, 1x swarm
					new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class, Skeleton.class,
							Thief.class,
							Swarm.class));
			case 7 ->
			...
			case 8 ->
				//2x skeleton, 1x thief, 2x DM-100, 2x guard, 1x necromancer
					new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class,
							Thief.class,
			...
			case 9, 10 ->
				//1x skeleton, 1x thief, 2x DM-100, 2x guard, 2x necromancer
					new ArrayList<>(Arrays.asList(Skeleton.class,
							Thief.class,
							DM100.class, DM100.class,
							Guard.class, Guard.class,
