...
public class SnipersMark extends FlavourBuff implements ActionIndicator.Action {
	...
	public String actionName() {
		...
		return switch (bow.augment) {
			default -> Messages.get(this, "action_name_snapshot");
			case SPEED -> Messages.get(this, "action_name_volley");
			case DAMAGE -> Messages.get(this, "action_name_sniper");
		};
	}
