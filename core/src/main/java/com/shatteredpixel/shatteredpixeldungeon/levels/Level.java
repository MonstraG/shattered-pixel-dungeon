...
public abstract class Level implements Bundlable {
	...
	public String tileName(int tile) {
		...
		return switch (tile) {
			case Terrain.CHASM -> Messages.get(Level.class, "chasm_name");
			case Terrain.EMPTY, Terrain.EMPTY_SP, Terrain.EMPTY_DECO, Terrain.CUSTOM_DECO_EMPTY, Terrain.SECRET_TRAP ->
					Messages.get(Level.class, "floor_name");
			case Terrain.GRASS -> Messages.get(Level.class, "grass_name");
			case Terrain.WATER -> Messages.get(Level.class, "water_name");
			case Terrain.WALL, Terrain.WALL_DECO, Terrain.SECRET_DOOR ->
					Messages.get(Level.class, "wall_name");
			case Terrain.DOOR -> Messages.get(Level.class, "closed_door_name");
			case Terrain.OPEN_DOOR -> Messages.get(Level.class, "open_door_name");
			case Terrain.ENTRANCE -> Messages.get(Level.class, "entrace_name");
			case Terrain.EXIT -> Messages.get(Level.class, "exit_name");
			case Terrain.EMBERS -> Messages.get(Level.class, "embers_name");
			case Terrain.FURROWED_GRASS -> Messages.get(Level.class, "furrowed_grass_name");
			case Terrain.LOCKED_DOOR -> Messages.get(Level.class, "locked_door_name");
			case Terrain.CRYSTAL_DOOR -> Messages.get(Level.class, "crystal_door_name");
			case Terrain.PEDESTAL -> Messages.get(Level.class, "pedestal_name");
			case Terrain.BARRICADE -> Messages.get(Level.class, "barricade_name");
			case Terrain.HIGH_GRASS -> Messages.get(Level.class, "high_grass_name");
			case Terrain.LOCKED_EXIT -> Messages.get(Level.class, "locked_exit_name");
			case Terrain.UNLOCKED_EXIT -> Messages.get(Level.class, "unlocked_exit_name");
			case Terrain.WELL -> Messages.get(Level.class, "well_name");
			case Terrain.EMPTY_WELL -> Messages.get(Level.class, "empty_well_name");
			case Terrain.STATUE, Terrain.STATUE_SP -> Messages.get(Level.class, "statue_name");
			case Terrain.INACTIVE_TRAP -> Messages.get(Level.class, "inactive_trap_name");
			case Terrain.BOOKSHELF -> Messages.get(Level.class, "bookshelf_name");
			case Terrain.ALCHEMY -> Messages.get(Level.class, "alchemy_name");
			default -> Messages.get(Level.class, "default_name");
		};
	}
	...
	public String tileDesc(int tile) {
		...
		return switch (tile) {
			case Terrain.CHASM -> Messages.get(Level.class, "chasm_desc");
			case Terrain.WATER -> Messages.get(Level.class, "water_desc");
			case Terrain.ENTRANCE -> Messages.get(Level.class, "entrance_desc");
			case Terrain.EXIT, Terrain.UNLOCKED_EXIT -> Messages.get(Level.class, "exit_desc");
			case Terrain.EMBERS -> Messages.get(Level.class, "embers_desc");
			case Terrain.HIGH_GRASS, Terrain.FURROWED_GRASS ->
					Messages.get(Level.class, "high_grass_desc");
			case Terrain.LOCKED_DOOR -> Messages.get(Level.class, "locked_door_desc");
			case Terrain.CRYSTAL_DOOR -> Messages.get(Level.class, "crystal_door_desc");
			case Terrain.LOCKED_EXIT -> Messages.get(Level.class, "locked_exit_desc");
			case Terrain.BARRICADE -> Messages.get(Level.class, "barricade_desc");
			case Terrain.INACTIVE_TRAP -> Messages.get(Level.class, "inactive_trap_desc");
			case Terrain.STATUE, Terrain.STATUE_SP -> Messages.get(Level.class, "statue_desc");
			case Terrain.ALCHEMY -> Messages.get(Level.class, "alchemy_desc");
			case Terrain.EMPTY_WELL -> Messages.get(Level.class, "empty_well_desc");
			default -> "";
		};
	}
}
